<template>
    <scroll-view class="content" scroll-y="true" @scroll="scrollPage" lower-threshold="120" @scrolltolower="scrolltolower">
        <view class="section">
            <view class="left">
                <view class="module" v-for="(item,index) of dataList" :key="index" v-if="index % 2 == 0" @tap="goFineArticle">
                    <view class="imgBox">
            ...
            <view class="right">
                <view class="module" v-for="(item,index) of dataList" :key="index" v-if="index % 2 == 1" @tap="goFineArticle">
                    <view class="imgBox">
                        <easy-loadimage mode="widthFix" :scroll-top="scrollTop" :image-src="item.coverUrl" loading-mode="skeleton-1"></easy-loadimage>
                    </view>
                    <view class="title">{{item.title}}</view>
